        ...
        <div class="max-w-screen-md mx-auto">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-900">PNG, JPG or GIF (MAX. 800x400px)
                                    </p>
                                </div>
          ...
          @endif
                    <div class="flex flex-col flex-wrap">
                        <h3>Judul</h3>
                        <input type="text" name="judul" id="" class="py-1 rounded-full border border-black">
                        <h3 class="mt-4">Deskripsi</h3>
                        <textarea name="deskripsi" id="" cols="30" rows="10"
                            class="w-full h-36 border border-black rounded-xl"></textarea>
                        <div class="flex flex-row justify-between">
                            <div></div>
                            <div class="w-[363px] h-[192px] ">
                                <div class="mb-2">
                                <h3 class="mt-3">Pilih Album</h3>
                                <select class="w-[579px] h-10 border border-black px-2" name="id_album" id="">
                            ...
                            <button type="submit" class="bg-blue-800 px-6 py-1 mt-4 text-white rounded-sm bg-biru">Post</button>
                        </div>
                    </div>
                </div>
            </div>
